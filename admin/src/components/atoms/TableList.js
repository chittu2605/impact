...
const TableList = (props) => {
  ...
  const handleUpdateClick = () => {
    if (checkAllFields()) {
      ...
      let { adpId, mobile, email, password, showMessages } = props;
      updateAdp(adpId, mobile, email, password, showMessages);
...
function updateAdp(adpId, phone, email, password, showMessages) {
