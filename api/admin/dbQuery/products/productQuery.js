...
const SELECT_PRODUCT_BY_CITY_CATEGORY_SUB_CATEGORY = (
  city_id,
  category_id,
  subCategoryId
) => {
...
const SELECT_PRODUCT_BY_TYPE_CATEGORY_SUB_CATEGORY = (
  product_type,
  category_id,
  subCategoryId
) => {
...
const INSERT_PRODUCT_FRANCHISE = (
  ...
  return `INSERT INTO tbl_product_franchise  (
        ...
        "${data.imageUrl}",
        "${data.short_desc === "" ? null : data.shortDesc}",
...
const SELECT_PRODUCT_BY_CITY_FRANCHISE_CATEGORY_SUB_CATEGORY = (
  city,
  category_id,
  subCategoryId,
  franchise_id
...
const SELECT_PRODUCT_BY_TYPE_CATEGORY_SUB_CATEGORY_ADMIN = (
  product_type,
  category_id,
  subCategoryId
) => {
...
const UPDATE_PRODUCT_FRANCHISE_QUANTITY = (
  details
) => `UPDATE tbl_product_franchise_quantity
SET product_id='${details.product_id}', quantity='${details.quantity}', unit_quantity=${details.unit_quantity}, unit='${details.unit}',
price=${details.price}, discount=${details.discount}, after_discount=${details.after_discount}, retail_profit=${details.retail_profit}, 
actual_price=${details.actual_price}, gst='${details.gst}', bv=${details.bv}, vdbc=${details.vdbc}, vdbd=${details.vdbd}, 
commision=${details.commision}, vdba=${details.vdba}, free_code='${details.free_code}', free_code_to='${details.free_code_to}', 
free_code_from='${details.free_code_from}', currency='${details.currency}', max_purchase='${details.max_purchase}'
WHERE id=${details.id}`;
...
const SELECT_FRANCHISE_PRODUCT = (
  pageNo,
  productType,
  city,
  franchiseId,
